...
class RoleandPermissionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.role.role-view', compact('role'));
    }
    ...
    public function create()
    {
        ...
        // dd($permissionsGroup);
        return view('admin.role.role-create', compact('permissions', 'permissionsGroup'));
    }
    ...
    public function edit($id)
    {
        ...
        $permissionsGroup = User::getpermissiongroup();
        return view('admin.role.role-edit', compact('role', 'all_permissions', 'permissionsGroup'));
    }
