            ...
            <div class="col-md-12">
                <div class="card border-0 mb-4 no-bg">
                    <div class="card-header py-3 px-0 d-flex align-items-center justify-content-between border-bottom">
                        <h3 class=" fw-bold flex-fill">Role Add</h3>
                        <div class="dropdown px-2">
                            <a href="{{ route('role-permission.create') }}" class="btn btn-outline-success"><b><i class="icofont-plus"></i> Create Role</b></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <span class="mt-2 badge border border-primary text-info mt-2">
                                {{ $per->name }}
                            </span>
                            @endforeach
                        </td>
                        <td class="about-info d-flex mt-3">
                            <a href="{{ route('role-permission.edit', $data->id) }}" class="btn btn-outline-success" title="Edit"><i class="icofont-edit"></i></a>&nbsp;
