                            ...
                            <div class="card-body text-white d-flex flex-column">
                                <div class="d-flex align-items-center mb-auto ">
                                    <div class="flex-fill ms-3 text-truncate">
                                        <h4 class=""><b><i>Settings Information</i></b> </h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="card">
                                        <div class="modal-content">
                                            <div class="modal-body">
                                                <div class="row g-1">
                                                    <form class="row g-1" action="{{ route('settings.store') }}" method="POST" enctype="multipart/form-data">
                                                        @csrf
                                                        <div class="col-6">
                                                            <div class="m-2">
                                                                <label class="form-label"><b>Software Title</b></label>
                                                                <input type="text" name="title" class="form-control form-control-lg" placeholder="Software Title">
                                                            </div>
                                                        </div>
                                                        <div class="col-6">
                                                            <div class="m-2">
                                                        ...
                                                        <div class="col-6">
                                                            <div class="m-2">
                                                                ...
                                                                <input type="text" name="company_phone" class="form-control form-control-lg" placeholder="Company Phone Number">
                                                            </div>
                                                        </div>
                                                        <div class="col-6">
                                                            <div class="m-2">
                                                                <label class="form-label"><b>Company Email</b></label>
                                                                <input type="email" name="company_email" class="form-control form-control-lg" placeholder="Company Email">
                                                            </div>
                                                        </div>
                                                        <div class="col-6">
                                                            <div class="m-2">
                                                                <label class="form-label"><b>Web Link</b></label>
                                                                <input type="text" name="web_link" class="form-control form-control-lg" placeholder="www.example.com">
                                                            </div>
                                                        </div>
                                                        <div class="col-6">
                                                            <div class="m-2">
                                                        ...
                                                        <div class="col-12">
                                                            <div class="m-2">
                                                                ...
                                                                <textarea name="address" id="" cols="70" rows="5"></textarea>
                                                            </div>
                                                        </div>
