                            ...
                            <div class="card-body text-white d-flex flex-column">
                                <div class="d-flex align-items-center mb-auto ">
                                    <div class="flex-fill ms-3 text-truncate">
                                        <h4 class=""><b><i>User Update</i></b> </h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="card">
                                        <div class="modal-content">
                                            <div class="modal-body">
                                                <form class="row g-1" action="{{ route('user-create.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                                                    @csrf
                                                    @method('PATCH')
                                                    <div class="row g-1">
                                                        <div class="col-6">
                                                        ...
                                                        <div class="col-6">
                                                            <div class="m-2">Password</b></label>
                                                        ...
                                                        <div class="col-6">
                                                            <div class="m-2">
                                                                ...
                                                                <textarea name="address" class="form-control" cols="60" rows="5" placeholder="Address">{{ $user->address }}</textarea>
                                                            </div>
                                                        </div>
                                                        <div class="col-12 text-right m-2 mt-4">
                                                            <button type="submit" class="btn btn-outline-success"><b>Update User</b></button>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
